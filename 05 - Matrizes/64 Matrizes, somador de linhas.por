// -----------------------------------------------
// Arquivo: 64 Matrizes, somador de linhas
// Tema: Matrizes e operações por linha/coluna
// Resumo: 64 Matrizes, somador de linhas
// -----------------------------------------------
programa
{
    ...
    funcao inicio()
    {
        ...
        para(l = 0; l < u.numero_linhas(matriz); l++){  // Loop para iterar sobre as linhas da matriz novamente
            ...
            escreva("Soma da ",l + 1, "Â° linha: ", soma, "\n")  // Imprime a soma da linha atual
            soma = 0  // Reseta a variÃ¡vel soma para a prÃ³xima linha
