...
programa
{
    funcao inicio()
    {
        ...
        cadeia nome = " ", hvelho = " ", hnovo = " ", mvelho = " ", mnovo = " " // declarando variÃ¡veis 
        inteiro cont = 1, idade = 0, hidmais = 0, hidmenos = 0, midmais = 0, midmenos = 0, toth = 0, totm = 0 // declarando variÃ¡veis 

        escreva("===== Procurando a pessoa mais jovem e a mais velha =====\n") // Mensagem pro usuÃ¡rio
        enquanto (cont <= 5) { // se contador menor que 5
            escreva("--------------------\n") // escreve uma linha
            escreva("\t", cont, "Â° Pessoa") // escreve cont 
            escreva("\n--------------------\n") // escreve linha
            escreva("Nome: ") // mesnagem pro usuÃ¡rio
            leia(nome)// Le e guarda na variÃ¡vel nome
            escreva("Idade: ") // mesnagem pro usuÃ¡rio
            leia(idade) // LÃª e guarda na variÃ¡vel idade
            escreva("Sexo (M/F): ") // mesnagem pro usuÃ¡rio
            leia(sexo) // lÃª e guarda na variÃ¡vel sexo
            
            se (sexo == 'M' ou sexo == 'm') { // se sexo == a M ou m faÃ§a
            	toth++
                ...
                } senao { // se  nÃ£o for o primeiro homem
                    se (idade > hidmais) {  // verifica se a idade Ã© maior que a idade do homem mais velho
