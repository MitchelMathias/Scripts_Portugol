// -----------------------------------------------
// Arquivo: 29 contagem interagindo
// Tema: Laços de repetição e contadores
// Resumo: 29 contagem interagindo
// -----------------------------------------------
programa
{
	...
	funcao inicio()
	{
		inteiro i = 1, f = 1, in = 1, con // Declarando variÃ¡veis
		escreva("\n============= Contagem =============") //cabeÃ§alho
		escreva("\nComeÃ§a em :") 
		...
		escreva("\n====================================\n")
		con = i
		enquanto (con <= f){ // enquanto contador for menor que fim faÃ§a
