// -----------------------------------------------
// Arquivo: 70 função quadrado
// Tema: Funções e modularização
// Resumo: 70 função quadrado
// -----------------------------------------------
programa
{
	inclua biblioteca Util --> u  // Inclui a biblioteca Util para funÃ§Ãµes auxiliares
	
	// FunÃ§Ã£o para desenhar um quadrado de tamanho 'tam'
	funcao vazio quadrado(inteiro tam){
		inteiro l = 0, c = 0  // VariÃ¡veis para controle das linhas e colunas
		// Loop externo para controlar as linhas do quadrado
		para (l = 0; l < tam; l++){
			// Loop interno para controlar as colunas do quadrado
			para(c = 0; c < tam; c++){
				escreva("â–ˆâ–ˆ")  // Escreve dois blocos preenchidos para representar um quadrado
				u.aguarde(70)  // Atraso de 70 ms entre a escrita de cada bloco
			}
			escreva("\n")  // Nova linha apÃ³s completar uma linha do quadrado
		}
		escreva(tam, " x ", tam, "\n\n")  // Exibe o tamanho do quadrado apÃ³s o desenho
	}
	
	// FunÃ§Ã£o principal que chama a funÃ§Ã£o 'quadrado' com diferentes tamanhos
	funcao inicio()
	{
