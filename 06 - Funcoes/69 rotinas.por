...
programa
{
	...
	// FunÃ§Ã£o personalizada para exibir texto com uma borda especial
	funcao vazio meu_escreva(cadeia txt, inteiro quant, inteiro modelo){
		inteiro cont = 0  // VariÃ¡vel para contar a quantidade de repetiÃ§Ãµes
		...
		escolha (modelo){
			...
			caso 3:
				...
				pare
			caso contrario:
				faixa = ""  // Sem borda para modelos nÃ£o especificados
		}
		
		escreva(faixa)  // Exibe a faixa de abertura
		// Loop para exibir o texto o nÃºmero de vezes especificado
		enquanto(cont < quant){
	...
	funcao inicio()
	{
		// Chama a funÃ§Ã£o meu_escreva com diferentes textos, quantidades e modelos de borda
		meu_escreva("Eu sou estudonauta", 1, 1)
		meu_escreva("Estou aprendendo a programar", 3, 2)
		meu_escreva("E estou curtindo", 2, 3)
		meu_escreva("Sucesso Total!!!", 5, 0)  // Sem borda, pois modelo Ã© 0
